...
class get_result(object):
    def __init__(self, host, data):
        ...
        self.Secret = "OWE5NjRiZTY0YTRkOThjN2M3Y2VjZjdi"
        # 接口APIKey（到控制台机器翻译服务页面获取）
        self.APIKey = "d0154245398b14492c3a56e2d4eba134"
        ...
        self.Text = data['text']
        self.BusinessArgs = data['businessargs']
...
class Translator(Resource):
    def post(self):
        ...
        #初始化类
        gClass = get_result(host, json_data)

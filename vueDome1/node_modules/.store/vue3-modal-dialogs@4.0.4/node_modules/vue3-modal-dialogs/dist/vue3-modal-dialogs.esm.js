...
var CLOSE_EVENT_VUE3 = 'onVue-modal-dialogs:close';
var ERROR_EVENT_VUE3 = 'onVue-modal-dialogs:error';
...
function filterUndefinedProps (props, component) {
  ...
  var res = props.filter(function (key) { return !propKeys[key]; });
  return res
}
...
var DialogsWrapper = {
  ...
  render: function render () {
    ...
    var on = Object.assign({}, this.$attrs); //optimization - filter only "onXxx.." properties

    // Modify the 'after-leave' event for the transition promise
    var afterLeave = on['onAfter-leave'] || noop;
    on['onAfter-leave'] = function (el) {
      el.$afterLeave();
      afterLeave(el);
    };
    ...
    var children = this.dialogIds.map(function (dialogId) {
      ...
      return h(data.component, Object.assign({}, on,
        {key: data.id},
        data.propsData))
    });

    // Render the wrapper as transition-group
    return h('transition-group', Object.assign({}, on, props), children)
  },
  methods: {
    /**
    ...
    add: function add (dialogData, args) {
      ...
      var finalPromise = dialogData.component.then(function (component) {
        ...
        this$1.dialogs[id] = renderOptions;
...
export { create, DialogsWrapper, install, makeDialog };
